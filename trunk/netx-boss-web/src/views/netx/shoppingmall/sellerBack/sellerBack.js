...
export default {
      ...
      btn_info: {
        condition: {
          ...
          list: [{
            ...
            fn: (opts) => {
              this.overBackData.id=opts.data.id
              this.overDialog.show=true
            }
          }]
        }
      }
  ...
  methods: {
    overReasonSubmit(){
      var data = this.overBackData
      this.$$api_shoppingmall_overBack({
          data,
          fn: result => {
            this.$message.success("解除成功")
            this.overDialog.show=false
            this.getList()
            this.overBackData.overReason=""
          }
      })
    },
