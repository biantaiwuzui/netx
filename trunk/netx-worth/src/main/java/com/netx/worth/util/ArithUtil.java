...
/**
 * 由于 Java 的简单类型不能够精确的对浮点数进行运算，这个工具类提供精 确的浮点数运算，包括加减乘除和四舍五入。
 */
public class ArithUtil {
    ...
    public static BigDecimal abs(BigDecimal v){
        return new BigDecimal(Math.abs(v.doubleValue()));
    }
     ...
     * @return
     */
    public static BigDecimal unAbs(BigDecimal v) {
        double i = v.doubleValue();
        return (i > 0) ? new BigDecimal(-i) : new BigDecimal(i);
    }
    public static void main(String args[]) {
        System.out.println(ArithUtil.div(10, 3, 10));
