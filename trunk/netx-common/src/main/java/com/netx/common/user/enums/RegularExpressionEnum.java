...
public enum RegularExpressionEnum {
    ...
    NICKNAME("昵称", "^[a-zA-Z\\d\\_\\u2E80-\\u9FFF]{2,14}$"),
    REAL_NAME("真实姓名", "^([\\u4e00-\\u9fa5]{2,20}|[a-zA-Z\\.\\s]{1,20})$"),
    ...
    ID_NUMBER("身份证号", "^[1-9]\\d{5}(18|19|([23]\\d))\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$");

    RegularExpressionEnum(String name, String value){
        this.name = name;
        this.value = value;
    };
