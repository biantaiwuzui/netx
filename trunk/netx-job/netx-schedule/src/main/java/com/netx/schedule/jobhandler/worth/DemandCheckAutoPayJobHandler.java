...
@JobHandler(value="DemandCheckAutoPayJobHandler")
@Component
public class DemandCheckAutoPayJobHandler extends IJobHandler{
    @Autowired
    ...
    public ReturnT<String> execute(String demandId) throws Exception {
        ...
        demandFuseAction.checkPublisherIsPay (demandId);
        return SUCCESS;
    }
}
