...
public class BlowfishUtils {
    ...
    private static final Log logger = LogFactory.getLog(BlowfishUtils.class);
    ...
    public static void main(String[] args) {
        final String tiger = BlowfishUtils.encryptBlowfish("gu.shoppingmall.session.session-key", "tiger");
